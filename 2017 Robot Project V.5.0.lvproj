...
AddOutputFilter chunkFilter
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="A Switch V.5.0.vi" Type="VI" URL="../A Switch V.5.0.vi"/>
			<Item Name="Auto Vision V.5.0.vi" Type="VI" URL="../Auto Vision V.5.0.vi"/>
			<Item Name="Backward Auto Veer V.5.0.vi" Type="VI" URL="../Backward Auto Veer V.5.0.vi"/>
			<Item Name="Begin Joystick V.5.0.vi" Type="VI" URL="../Begin Joystick V.5.0.vi"/>
			<Item Name="Begin Motors V.5.0.vi" Type="VI" URL="../Begin Motors V.5.0.vi"/>
			<Item Name="Boost and Slow V.5.0.vi" Type="VI" URL="../Boost and Slow V.5.0.vi"/>
			<Item Name="Bumper Switch V.5.0.vi" Type="VI" URL="../Bumper Switch V.5.0.vi"/>
			<Item Name="Elapsed Times V.5.0.vi" Type="VI" URL="../Elapsed Times V.5.0.vi"/>
			<Item Name="Forward Auto Veer V.5.0.vi" Type="VI" URL="../Forward Auto Veer V.5.0.vi"/>
			<Item Name="Gyro Veering V.5.0.vi" Type="VI" URL="../Gyro Veering V.5.0.vi"/>
			<Item Name="Pneumatics V.5.0.vi" Type="VI" URL="../Pneumatics V.5.0.vi"/>
			<Item Name="Read Ball Dumper V.5.0.vi" Type="VI" URL="../Read Ball Dumper V.5.0.vi"/>
			<Item Name="Read Encoder V.5.0.vi" Type="VI" URL="../Read Encoder V.5.0.vi"/>
			<Item Name="Read Gear Wings V.5.0.vi" Type="VI" URL="../Read Gear Wings V.5.0.vi"/>
			<Item Name="Read Switches V.5.0.vi" Type="VI" URL="../Read Switches V.5.0.vi"/>
			<Item Name="Target Stuff V.5.0.vi" Type="VI" URL="../Target Stuff V.5.0.vi"/>
			<Item Name="Teleop Ball V.5.0.vi" Type="VI" URL="../Teleop Ball V.5.0.vi"/>
			<Item Name="Teleop Climb V.5.0.vi" Type="VI" URL="../Teleop Climb V.5.0.vi"/>
			<Item Name="Teleop Drive V.5.0.vi" Type="VI" URL="../Teleop Drive V.5.0.vi"/>
			<Item Name="Teleop Gear V.5.0.vi" Type="VI" URL="../Teleop Gear V.5.0.vi"/>
			<Item Name="Y Switch V.5.0.vi" Type="VI" URL="../Y Switch V.5.0.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			<Item Name="Autonomous Independent V.5.0.vi" Type="VI" URL="../Autonomous Independent V.5.0.vi"/>
			<Item Name="Begin V.5.0.vi" Type="VI" URL="../Begin V.5.0.vi"/>
			<Item Name="Disabled V.5.0.vi" Type="VI" URL="../Disabled V.5.0.vi"/>
			<Item Name="Finish V.5.0.vi" Type="VI" URL="../Finish V.5.0.vi"/>
			<Item Name="Periodic Tasks V.5.0.vi" Type="VI" URL="../Periodic Tasks V.5.0.vi"/>
			<Item Name="Robot Global Data V.5.0.vi" Type="VI" URL="../Robot Global Data V.5.0.vi"/>
			<Item Name="Teleop V.5.0.vi" Type="VI" URL="../Teleop V.5.0.vi"/>
			<Item Name="Test V.5.0.vi" Type="VI" URL="../Test V.5.0.vi"/>
			<Item Name="Vision Processing V.5.0.vi" Type="VI" URL="../Vision Processing V.5.0.vi"/>
		</Item>
		<Item Name="Robot Main V.5.0.vi" Type="VI" URL="../Robot Main V.5.0.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Ideal Center V.4.0.vi" Type="VI" URL="../Ideal Center V.4.0.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[1].itemID" Type="Ref">/Target/Robot Main V.5.0.vi</Property>
